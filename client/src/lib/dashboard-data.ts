export const revenueTrend = [
  { month: "Mar", receita: 32.4, meta: 34.2 },
  { month: "Abr", receita: 34.8, meta: 35.1 },
  { month: "Mai", receita: 36.6, meta: 36.5 },
  { month: "Jun", receita: 38.1, meta: 37.4 },
  { month: "Jul", receita: 41.5, meta: 39.8 },
  { month: "Ago", receita: 48.2, meta: 42.5 },
];
...
export const executiveInsights = [
  {
    title: "Receita acima do ritmo projetado",
    description: "A receita de agosto superou a meta mensal em 13,4%, impulsionada por Luanda e pelo canal direto.",
    tone: "blue",
  },
  {
